    ...
    private var mainListSection: some View {
        if isCompletelyEmpty {
            ContentUnavailableView(
                ...
                description: Text(searchText.isEmpty ? "Add friends to split expenses with them." : "No friends match \"\(searchText)\"")
            )
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    Text("Find your friend on PayUp by their username. When they accept, all past splits with this placeholder will transfer to them.")
                }
