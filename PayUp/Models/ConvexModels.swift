...
enum ActivityType: String, Codable {
    ...
    var emoji: String {
        ...
        case .invitationAccepted: return "🤝"
        case .invitationRejected: return "🙅‍♂️"
        case .invitationCancelled: return "👎"
        case .friendRemoved: return "💔"
        case .splitCreated: return "🧾"
        case .splitEdited: return "📝"
        case .splitDeleted: return "🗑️"
        case .settlementRecorded: return "🤑"
        }
    }
